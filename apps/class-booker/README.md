...
Calendar events share the existing week view, with navigation across the supplied discovery window. Recurring booking shortcuts still cover only this week and next week. Calendar decisions and invalidations supersede legacy tickets for the same occurrence. Missing, review and cancelled events cannot offer a purchase button.
